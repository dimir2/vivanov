...
public class ManualLoaderTest {
    ...
    public void whenSimpleOrderBookGivenThenItIsLoaded() {
        ClassLoader classLoader = getClass().getClassLoader();
        String file = classLoader.getResource("orders-004.xml").getPath();

        Loader loader = ManualLoader.getInstance();
     ...
     */
    @Test
    public void whenLoadWholeOrderBookThenItTakesLessThanFiveSeconds() {
        ClassLoader classLoader = getClass().getClassLoader();
